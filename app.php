...
<!-- Pressbreak is installed at: <?php echo realpath(dirname(__FILE__)); ?> -->
<head>
  <meta charset="utf-8">
...
<body>
  <div class="container">
    ...
    <footer class="footer">
      <p>
        Pressbreak | Available on <a href="https://github.com/pressbreak/pressbreak"><i class="fa fa-github"></i> Github</a> | Licensed <a href="https://www.gnu.org/licenses/gpl-2.0.html">GPLv2</a>        <span class="pull-right"><a href="#" class="back-to-top"><span class="glyphicon glyphicon-arrow-up" aria-hidden="true"></span> Back to top</a></span>
        <br/>
      </p>
    </footer>
